                ...
                {achievementsData.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            {item.image && (
                                <div className="mb-4 -mx-6 -mt-6 overflow-hidden rounded-t-xl h-48 border-b border-gray-100 dark:border-gray-800">
                                    <img 
                                        src={item.image} 
                                        alt={item.title} 
                            ...
                            <div className="flex items-center justify-between mb-4 mt-1">
                                <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${item.color} p-2.5 shadow-lg`}>
